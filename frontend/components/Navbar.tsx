...
export default function Navbar() {
  ...
  return (
    <nav className="bg-ehr-blue dark:bg-ehr-dark shadow-md sticky top-0 z-50">
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="md:hidden">
            <button
              ...
              className="text-white dark:text-gray-300 p-2 rounded-md"
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="md:hidden bg-ehr-blue dark:bg-ehr-dark border-t border-ehr-blue-dark dark:border-gray-700">
            ...
            {user && (
              <>
                ...
                <Link
                  href="/admin"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="block text-white dark:text-gray-300 hover:text-ehr-light dark:hover:text-gray-100 transition px-3 py-2 rounded-md text-base font-medium bg-blue-600 dark:bg-blue-700"
                >
                  Admin
                </Link>
                <Link
                  ...
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="block text-white dark:text-gray-300 hover:text-ehr-light dark:hover:text-gray-100 transition px-3 py-2 rounded-md text-base font-medium bg-green-600 dark:bg-green-700"
                >
                  Encadrants
                </Link>
              </>
